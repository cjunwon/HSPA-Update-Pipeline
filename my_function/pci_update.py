...
s3_bucket = 'adrian-sri-test-bucket'
s3_key_main_db = 'Hillside-Data/data/hillside_inventory_LA_centrality_full_new_evacmidnorth_UPDATED_copy.geojson'
s3_key_street_centerline = 'Hillside-Data/data/Streets_Centerline_For_URL.geojson'
...
def update_pci():
    print("Updating PCI values...")
    update_pci_navigateLA()
    print("Navigatela updated")
    update_pci_data_lacity()
    print("Data LA City updated")
    update_missing_point()
    print("Missing points updated")
